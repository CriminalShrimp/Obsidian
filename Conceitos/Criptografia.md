...
<figure style="text-align: center;">
  ...
  <figcaption>Passo a passo ECDH.</figcaption>
</figure>

<p style="text-align:center;">Em uma visualização de como ficaria esses pontos em uma curva elíptica seria algo parecido com isso:</p>

<figure style="text-align: center;">
  <img src="ECDH Grafico.png" style="margin: 0 auto;">
  <figcaption>Gráfico com os pontos.</figcaption>
</figure>

Esse exemplo usado é bem simplificado, com uma curva pequena, chaves sem estar, números de 256 bits, campos infinitos maiores e algoritmos otimizados.
