...
- **2 (parâmetro da curva)** → valor **a**
    
- **2 (parâmetro da curva)** → valor **b**
    
- **17 (número primo)** → valor **p**, que define o campo finito
    

Todos os cálculos são feitos **mod 17**.

---

# 2️⃣ Pontos da curva

Alguns pontos válidos dessa curva são:
...
Cada par **(x,y)** satisfaz a equação da curva.

---

# 3️⃣ Escolhendo o ponto gerador
...
Esse ponto será usado para gerar as chaves.

---

# 4️⃣ Multiplicação do ponto G

Agora calculamos múltiplos de **G**.
...
Cada resultado é **outro ponto válido da curva**.

---

# 5️⃣ Alice cria suas chaves

Alice escolhe um número secreto:
...
- **B → chave pública de Bob**
    

---

# 7️⃣ Troca de chaves públicas
...
Esses valores podem ser vistos por qualquer pessoa.

---

# 8️⃣ Alice calcula o segredo
...
Os dois obtêm o mesmo segredo:

S = 6G

Esse ponto da curva vira o **segredo compartilhado**.
...
Para descobrir **a** ou **b**, ele teria que resolver o **Elliptic Curve Discrete Logarithm Problem**, que é considerado extremamente difícil.

---

✅ **Fluxo real do exemplo**
